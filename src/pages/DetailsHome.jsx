...
const DetailsHome = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>HomeSpotter || Details Home</title>
            </Helmet>
            ...
            <div className="hero min-h-screen bg-base-300 my-10">
                <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={image} alt={estate_title} className="w-full h-96 object-cover object-center rounded-lg" />
                <div className="p-6">
                    <div className="text-xl font-bold text-gray-800">{estate_title}</div>
                    <p className="text-sm italic text-gray-600 mb-4">{segment_name}</p>
                    <p className="text-gray-700 mb-4">{description}</p>
